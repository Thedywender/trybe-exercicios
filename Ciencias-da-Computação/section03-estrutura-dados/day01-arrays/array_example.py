...
class ListaArray:
    ...
    def update(self, index, value):
        # atualiza o valor no índice informado
...
array.remove(0)  # retorna a string "Felipe"
print(array)  # saída: ['Ana', 'Shirley', 'Miguel]

array.update(0, "Patrícia")
print(array)  # saída: ['Patrícia', 'Shirley', 'Miguel'] --- seguindo o codigo acima
